...
import com.cfs.RideTap.apis.BookingHistoryApi;
...
import com.cfs.RideTap.utils.Mappers.BookingDTOMapper;
...
public class BookingHistoryController implements BookingHistoryApi {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<BookingDTO> getById(@Valid @PathVariable Long id, HttpServletRequest request) {
    HttpSession session = request.getSession();
    String metroCardNumber = (String) session.getAttribute("metroCardNumber");
